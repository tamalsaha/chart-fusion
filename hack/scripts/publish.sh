...
helm repo index testdata/archives/ --url https://storage.googleapis.com/bundles.kubepack.com/ui

gsutil rsync -d -r testdata/archives gs://bundles.kubepack.com/ui
gsutil acl ch -u AllUsers:R -r gs://bundles.kubepack.com/ui
